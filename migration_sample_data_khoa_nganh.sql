...
-- ============================================================================
-- Chạy file này trong phpMyAdmin để thêm dữ liệu mẫu
-- ============================================================================
...
-- KIỂM TRA KẾT QUẢ
-- ============================================================================
SELECT 'Khoa:' AS Info, COUNT(*) AS Total FROM KHOA;
SELECT 'Ngành:' AS Info, COUNT(*) AS Total FROM NGANH;
SELECT 'Môn học:' AS Info, COUNT(*) AS Total FROM MON_HOC;
